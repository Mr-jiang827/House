...
public class SwaggerConfig {
    ...
    public ApiInfo createAI(){
        ApiInfo apiInfo=new ApiInfoBuilder().title("饿了没系统后端接口文档").
                description("elm系统的所有接口信息，可以查看对应的接口信息和对接口进行测试").
    ...
    public Docket createD(){
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(createAI()).select().
                apis(RequestHandlerSelectors.basePackage("com.housedemo.houseapi.controller")).build();
    }
